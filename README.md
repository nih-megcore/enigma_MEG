[![DOI](https://zenodo.org/badge/294786606.svg)](https://doi.org/10.5281/zenodo.14616848)
# Installation
...
mamba create --override-channels --channel=conda-forge --name=enigma_meg 'mne>=1.6' 'python<3.12'
